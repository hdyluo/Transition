//
//  UINavigationController+YGTranslation.m
//  YGTranslation
//
...
#import "UINavigationController+YGTranslation.h"
#import <objc/runtime.h>
#import <objc/message.h>

@implementation UINavigationController (YGTranslation)
+ (void)load{
...
- (void)xw_pushViewController:(UIViewController *)viewController withAnimator:(YGBaseAnimator *)animator {
    if (!viewController) return;
    YGBaseInteractor *toInteractive = objc_getAssociatedObject(self.topViewController, &kXWToInteractiveKey);
    if (toInteractive) {
